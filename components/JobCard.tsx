...
function IconMoney() {
  return (
    ...
    >
      ...
      />
      <path
        d="M17 5H7a4 4 0 000 8h10a4 4 0 010 8H7"
        stroke="#c04b3b"
        strokeWidth="1.6"
        strokeLinecap="round"
        strokeLinejoin="round"
...
function IconPin() {
  return (
    ...
    >
      ...
      />
      <path
        d="M21 11.5c0 6-9 11-9 11s-9-5-9-11a9 9 0 1118 0z"
        stroke="#6b6b6b"
        strokeWidth="1.2"
        strokeLinecap="round"
        strokeLinejoin="round"
    ...
    <div className="job-card">
      <div className="job-left">
        ...
        <div className="meta small">
          <span>
            <IconMoney />₹{job.salary}/day
          </span>
          <span>
            <IconPin />
            {typeof job.distanceKm === "number" && isFinite(job.distanceKm)
